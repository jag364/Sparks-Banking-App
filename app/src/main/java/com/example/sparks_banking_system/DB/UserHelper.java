package com.example.sparks_banking_system.DB;
...
public class UserHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // Insert Into Table
        db.execSQL("insert into " + TABLE_NAME + " values(7860,'Jagdeesh Gupta', 'jagdeesh@gmail.com','7584','7895641238', 15000)");
        db.execSQL("insert into " + TABLE_NAME + " values(5862,'Harsh Gupta', 'harsh@gmail.com','1258','8995641238', 5000)");
        db.execSQL("insert into " + TABLE_NAME + " values(7895,'Akash choudhry', 'akash@gmail.com','8896','7595645896', 1000)");
        db.execSQL("insert into " + TABLE_NAME + " values(1258,'Aman Kesharwani', 'aman@gmail.com','7752','9995640038', 8000)");
        db.execSQL("insert into " + TABLE_NAME + " values(7410,'Ankit Sahu', 'ankit@gmail.com','3669','9095648962', 7500)");
